...
public class Fighter extends Characters {
    ...
    public Fighter(int x, int y) {
        super(x, y, 50, 50, 4, 150, 25, 100, new ImageIcon("assets/cat1.png"),"Fighter", null);
    }

    public Fighter(int x, int y, Weapons weapon) {
        super(x, y, 50, 50, 4, 150, 25, 100, new ImageIcon("assets/cat1.png"),"Fighter", new LongSword(x+25,y+25));
